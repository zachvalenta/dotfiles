...
alias box="cd $HOME/Desktop/zvmac/materials/sw/za/data/scorecard"
...
alias mlib="cd /Volumes/MUSIC-LIB/art && t > ~/Desktop/music-lib-$(date +"%Y%m%d").log" # make sure nothing awful happens if MUSIC-LIB not mounted
